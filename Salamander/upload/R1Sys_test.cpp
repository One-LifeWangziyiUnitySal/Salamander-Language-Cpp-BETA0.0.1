        ...
        if(startsWith(s,"Module(")){
            ...
            if(p1!=string::npos&&p2!=string::npos&&p2>p1){
                ...
                if(!modName.empty()){
                    ...
                    string savedModule=g_currentModule;g_currentModule=modName;
